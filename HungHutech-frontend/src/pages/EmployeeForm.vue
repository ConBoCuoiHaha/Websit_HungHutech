  ...
  <el-card class="orangehrm-form-card" shadow="never">
    <template #header>
      <div class="orangehrm-card-header">
        <h2 class="orangehrm-card-title">{{ isEdit ? 'Chỉnh sửa nhân viên' : 'Thêm nhân viên mới' }}</h2>
      </div>
    </template>
    ...
    >
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="Email" prop="email" required>
              <el-input v-model="form.email" type="email" placeholder="nguyenvanan@company.com" />
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <div class="form-section">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Phòng ban" prop="phong_ban_id" required>
              <el-select v-model="form.phong_ban_id" placeholder="Chọn phòng ban" style="width: 100%">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="Chức danh" prop="chuc_danh_id" required>
              <el-select v-model="form.chuc_danh_id" placeholder="Chọn chức danh" style="width: 100%">
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Ngày bắt đầu" prop="ngay_bat_dau_lam_viec" required>
              <el-date-picker
          ...
          <el-col :span="12">
            <el-form-item label="Trạng thái" prop="trang_thai_lao_dong_id" required>
              <el-select v-model="form.trang_thai_lao_dong_id" placeholder="Chọn trạng thái" style="width: 100%">
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="Loại hợp đồng" prop="loai_hop_dong">
              <el-select v-model="form.loai_hop_dong" placeholder="Chọn loại hợp đồng" style="width: 100%">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="Số tài khoản" prop="so_tai_khoan_ngan_hang">
              <el-input v-model="form.so_tai_khoan_ngan_hang" placeholder="1234567890" />
            </el-form-item>
          </el-col>
        </el-row>
      </div>
...
const formRules: FormRules = {
  ho_dem: [{required: true, message: 'Vui lòng nhập họ và tên đệm', trigger: 'blur'}],
  ten: [{required: true, message: 'Vui lòng nhập tên', trigger: 'blur'}],
  email: [
    {required: true, message: 'Vui lòng nhập email', trigger: 'blur'},
    {type: 'email', message: 'Email không hợp lệ', trigger: 'blur'},
  ],
  phong_ban_id: [{required: true, message: 'Vui lòng chọn phòng ban', trigger: 'change'}],
  chuc_danh_id: [{required: true, message: 'Vui lòng chọn chức danh', trigger: 'change'}],
  trang_thai_lao_dong_id: [{required: true, message: 'Vui lòng chọn trạng thái', trigger: 'change'}],
  ngay_bat_dau_lam_viec: [{required: true, message: 'Vui lòng chọn ngày bắt đầu', trigger: 'change'}],
};
  ...
  try {
    ...
    if (isEdit.value) {
      ...
      Object.assign(form, {
        ...
        trang_thai_lao_dong_id: employee.trang_thai_lao_dong_id?._id || employee.trang_thai_lao_dong_id || '',
        ngay_bat_dau_lam_viec: employee.ngay_bat_dau_lam_viec?.split('T')[0] || '',
        loai_hop_dong: employee.loai_hop_dong || '',
        quan_ly_truc_tiep_id: employee.quan_ly_truc_tiep_id?._id || employee.quan_ly_truc_tiep_id || '',
...
const handleSave = async () => {
  ...
  try {
    ...
    ElMessage.error(err.response?.data?.msg || 'Không thể lưu thông tin nhân viên');
  } finally {
    saving.value = false;
  }
};
