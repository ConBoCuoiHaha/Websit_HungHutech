...
// Serve uploads statically (requires auth at download time? Here kept open or can add auth gate)
...
// Serve Frontend (Hung Hutech HRM)
const frontendPath = path.join(__dirname, '../Hung-frontend/dist');
